...
//
// Input: an array of sets, each { exName, weight, date, warmup? }. Returns
// { [exName]: { weight, date } } — the heaviest non-warmup, positive-weight set per
// exercise and the date it was achieved. Mirrors flagPRs's filter (skip warmup & weight<=0).
//
